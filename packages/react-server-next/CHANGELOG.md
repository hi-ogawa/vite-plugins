...
- feat(next): auto load dotenv for dev and preview ([#637](https://github.com/hi-ogawa/vite-plugins/pull/637))
- refactor!: remove `next/*.js` exports ([#647](https://github.com/hi-ogawa/vite-plugins/pull/647))
- refactor(next): simplify `envPrefix` merge ([#636](https://github.com/hi-ogawa/vite-plugins/pull/636))
- fix(next): fix reload dot env ([#657](https://github.com/hi-ogawa/vite-plugins/pull/657))
